  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen ">
      ...
      <main className="flex flex-col items-center justify-center flex-1 w-full text-center">
        <Image src="/tapago.svg" alt="Tá Pago? Logo" width={150} height={150} />
        <h1 className="text-18.75x font-mono px-20">
          VERIFICADOR DE TRANSFERÊNCIAS/DEPÓSITOS
        </h1>

        <h2 className="inline-flex pt-3 space-x-2">
          <div>Verifique se um comprovativo é</div>
          <div className="bg-green-100">verdadeiro</div>
          <div>ou</div>
          <div className="bg-red-100 ">falso.</div>
        </h2>
